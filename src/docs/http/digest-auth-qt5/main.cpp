...
int main(int argc, char *argv[]) {
    ...
    QCoreApplication::setOrganizationName("DigestAuthQt5");
    QCoreApplication::setOrganizationDomain("digest_auth_qt5.com");
    QCoreApplication::setApplicationName("digest_auth_qt5");
    ...
    parser.setApplicationDescription("Digest Auth Qt5 Description");
